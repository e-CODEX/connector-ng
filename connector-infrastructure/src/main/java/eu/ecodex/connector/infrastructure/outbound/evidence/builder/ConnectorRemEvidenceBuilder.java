...
package eu.ecodex.connector.infrastructure.outbound.evidence.builder;
...
import eu.ecodex.connector.infrastructure.outbound.evidence.spocseu.evidences.DeliveryNonDeliveryToRecipient;
import eu.ecodex.connector.infrastructure.outbound.evidence.spocseu.evidences.Evidence;
import eu.ecodex.connector.infrastructure.outbound.evidence.spocseu.evidences.RelayREMMDAcceptanceRejection;
import eu.ecodex.connector.infrastructure.outbound.evidence.spocseu.evidences.RelayREMMDFailure;
import eu.ecodex.connector.infrastructure.outbound.evidence.spocseu.evidences.RetrievalNonRetrievalByRecipient;
import eu.ecodex.connector.infrastructure.outbound.evidence.spocseu.evidences.SubmissionAcceptanceRejection;
import eu.ecodex.connector.infrastructure.outbound.evidence.spocseu.messageparts.SpocsFragments;
...
/**
 * The {@code ConnectorRemEvidenceBuilder} class is responsible for constructing and signing REM
 * evidences according to the Connector architecture requirements.
 */
@Slf4j
@Component
