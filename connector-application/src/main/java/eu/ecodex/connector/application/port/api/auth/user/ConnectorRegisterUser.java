...
/**
 * Interface for managing the registration and updates of {@link ConnectorUser} entities in the system.
...
public interface ConnectorRegisterUser {
     ...
     *
     * @param user the {@link ConnectorUser} to be registered; must not be null and should contain valid user information
     * @return the registered {@link ConnectorUser} with updated metadata (e.g., generated UUID, creation timestamp)
     */
     ...
     *
     * @param identifier the unique identifier of the {@link ConnectorUser} to be updated; must not be null
     * @param user       the {@link ConnectorUser} object containing the updated information; must not be null
    ...
    /**
     * Partially updates an existing {@link ConnectorUser} entity identified by the given ID with the provided updates.
     * Only the non-null fields in the provided user object will be updated in the existing entity.
     *
     * @param identifier the unique identifier of the {@link ConnectorUser} to be patched; must not be null
     * @param user       the {@link ConnectorUser} object containing the fields to update; must not be null
