...
import eu.ecodex.connector.application.service.impl.message.ConnectorGatewayConfirmationMessageProcessorService;
...
public class ConnectorGatewayConfirmationMessageProcessorServiceTest {
    ...
    @InjectMocks
    private ConnectorGatewayConfirmationMessageProcessorService processor;
    ...
    void should_ignore_irrelevant_evidence_but_still_forward_confirmation_message() {
        ...
        when(messageRepository.findByEbmsMessageIdentifier(REFERENCED_EBMS_ID))
                .thenReturn(referencedMessage);
        org.mockito.Mockito.doThrow(new ConnectorEvidenceNotRelevantException(
