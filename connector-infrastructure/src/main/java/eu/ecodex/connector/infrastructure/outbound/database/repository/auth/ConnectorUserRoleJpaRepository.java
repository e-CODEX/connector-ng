 ...
 * Provides additional methods for retrieving entities based on specific attributes.</p>
 */
@Repository
public interface ConnectorUserRoleJpaRepository extends JpaRepository<ConnectorRoleEntity, Long> {
    /**
