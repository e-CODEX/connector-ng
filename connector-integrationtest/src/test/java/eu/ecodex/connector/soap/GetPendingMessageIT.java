...
public class GetPendingMessageIT extends AbstractIntegrationTest {
    ...
    @Test
    void should_retrieve_a_pending_messages_by_transport_step_identifier_successfully()
    ...
    @Test
    void should_failed_to_retrieve_a_pending_messages_by_transport_step_identifier() {
        var request = new GetMessageByIdRequest();
