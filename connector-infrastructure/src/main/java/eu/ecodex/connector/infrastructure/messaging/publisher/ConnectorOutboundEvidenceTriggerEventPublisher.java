...
public class ConnectorOutboundEvidenceTriggerEventPublisher implements ConnectorEventPublisher {
    private final JmsTemplate jmsTemplate;
    private final ConnectorQueueProperties queueProperties;

    public ConnectorOutboundEvidenceTriggerEventPublisher(
    ...
    public void publish(@NonNull ConnectorMessage message) {
        log.info(
                "Submitting evidence trigger message [{}] to processing queue",
                message.identifier()
        );
