...
@Component
@Transactional
public class ConnectorAssignRoleService implements ConnectorAssignRole {
    private final ConnectorRetrieveRoleByName retrieveRoleByName;
    private final ConnectorUserRepository userRepository;

    public ConnectorAssignRoleService(ConnectorRetrieveRoleByName retrieveRoleByName,
