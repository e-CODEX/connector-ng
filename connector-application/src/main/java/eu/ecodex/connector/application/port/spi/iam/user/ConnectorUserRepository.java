...
public interface ConnectorUserRepository {
     ...
     * @return an Optional containing the ConnectorUser if found, or an empty Optional if no user exists with the given identifier
     */
     ...
     * @return an Optional containing the ConnectorUser if found, or an empty Optional if no user exists with the given username
     */
     ...
     * @return an Optional containing the ConnectorUser if found, or an empty Optional if no user exists with the given email
     */
     ...
     * @return an {@code Optional} containing the {@code ConnectorUser} if found, or an empty {@code Optional} if no user exists with the given username and email
     */
     ...
     * empty {@code List}.
     *
     * @return a {@code List} of all {@code ConnectorUser} entities, or an empty {@code List} if no users exist
     */
