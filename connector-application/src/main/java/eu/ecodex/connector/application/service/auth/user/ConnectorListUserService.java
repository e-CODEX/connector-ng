 ...
 * by integrating with the underlying persistence layer through the {@link ConnectorUserRepository}.
 * It acts as a bridge between the application logic and the data access layer for user data operations.
 */
@Slf4j
@Service
