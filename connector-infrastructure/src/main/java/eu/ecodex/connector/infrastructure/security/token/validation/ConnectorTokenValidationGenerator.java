...
import eu.ecodex.connector.infrastructure.security.model.token.ConnectorTokenAuthenticationData;
import eu.ecodex.connector.infrastructure.security.model.token.ConnectorTokenDocument;
import eu.ecodex.connector.infrastructure.security.model.token.ConnectorTokenIssuer;
...
import eu.ecodex.connector.infrastructure.security.model.token.signature.ConnectorTokenAuthenticationCertificate;
import eu.ecodex.connector.infrastructure.security.model.token.signature.ConnectorTokenSignature;
import eu.ecodex.connector.infrastructure.security.token.validation.legal.ConnectorTokenLegalValidationGenerator;
...
import eu.ecodex.connector.infrastructure.security.util.DigestUtil;
