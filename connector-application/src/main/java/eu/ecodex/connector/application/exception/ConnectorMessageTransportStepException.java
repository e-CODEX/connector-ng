 ...
 * that occur specifically while the message is being transported between systems or services. It
 * provides a way to capture and handle transport-related issues separately from other
