...
public class ConnectorOutboundMessageSubmissionAcceptanceStepTest {
    @Mock
    ...
    void setUp() {
        ...
        outboundMessageSubmissionAcceptanceCreationStep = new ConnectorOutboundMessageSubmissionAcceptanceStep(
    ...
    void should_create_outbound_message_execute_relay_remmd_acceptance_evidence() {
        ...
        assertThat(connectorMessageService.isBusinessMessage(outputMessage)).isTrue();
