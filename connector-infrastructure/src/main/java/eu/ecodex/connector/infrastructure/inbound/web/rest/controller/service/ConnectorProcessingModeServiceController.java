...
/**
 * Defines the REST controller for managing services within the connector system.
 */
@RestController
public class ConnectorProcessingModeServiceController implements ConnectorProcessingModeServiceApi {
    private final ConnectorListProcessingModeServices listProcessingModeServicesService;

    public ConnectorProcessingModeServiceController(
    ...
    @Override
    public List<ConnectorService> listServices(String businessDomain) {
        return listProcessingModeServicesService.execute(businessDomain);
    }
}
