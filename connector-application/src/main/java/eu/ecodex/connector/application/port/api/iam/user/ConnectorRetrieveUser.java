...
public interface ConnectorRetrieveUser {
     ...
     * @throws NotFoundException if no user is found with the specified identifier
     */
    ConnectorUser getById(String identifier) throws NotFoundException;
     ...
     * @throws NotFoundException if no user is found with the given username and email address
     */
