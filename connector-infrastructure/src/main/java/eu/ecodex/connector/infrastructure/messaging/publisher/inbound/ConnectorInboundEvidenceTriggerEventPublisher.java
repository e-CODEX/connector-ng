...
package eu.ecodex.connector.infrastructure.messaging.publisher.inbound;
 ...
 */
@Slf4j
@Component("connectorInboundEvidenceTriggerEventPublisher")
public class ConnectorInboundEvidenceTriggerEventPublisher implements ConnectorEventPublisher {
    private final JmsTemplate jmsTemplate;
    private final ConnectorQueueProperties queueProperties;

    public ConnectorInboundEvidenceTriggerEventPublisher(
