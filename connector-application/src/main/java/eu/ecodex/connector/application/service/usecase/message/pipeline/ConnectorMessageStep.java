...
package eu.ecodex.connector.application.service.usecase.message.pipeline;
 ...
 *
 * <p>This interface is intended to process {@link ConnectorMessage} objects and return a modified
 * or new instance of {@link ConnectorMessage}. Implementations of this interface can represent
 * different stages of message handling, such as validation, transformation, or routing.
 *
 ...
 */
public interface ConnectorMessageStep {
    /**
     ...
     *
     * @return a new or modified {@link ConnectorMessage} instance as the result of the processing
