 ...
 * business domain rules of the connector.
 */
public class ConnectorBusinessDomainException extends RuntimeException {
    public ConnectorBusinessDomainException(String message) {
        super(message);
    }
}
