...
package eu.ecodex.connector.infrastructure.outbound.security.token.validation.legal;
...
public class ConnectorTokenLegalValidationGenerator {
     ...
     *
     * @throws ConnectorTokenException if either the validation object or the technical validation
     *                                 result is missing from the token.
     */
