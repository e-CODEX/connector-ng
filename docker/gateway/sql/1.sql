...
--  Ran at: 11/25/25, 7:15 PM
--  Against: null@offline:mysql?changeLogFile=target/liquibase/changelog-1.16-data.mysql
--  Liquibase version: 4.17.0
--  *********************************************************************

--  Changeset src/main/resources/db/releases/5.1.9/../../common/changelog-before-migration-statements-v2.xml::EDELIVERY-12287_assert_previous_migration_succeeded-v2-mysql::Gabriel Maier
DELIMITER //
...
--  Changeset src/main/resources/db/releases/5.1.9/../../common/changelog-version-inserts.xml::EDELIVERY-7668-mysql::Catalin Enache
INSERT INTO TB_VERSION (VERSION, BUILD_TIME, CREATION_TIME) VALUES ('5.1.9', '2025-11-25 17:14', (UTC_TIMESTAMP))
            ON DUPLICATE KEY UPDATE BUILD_TIME='2025-11-25 17:14', CREATION_TIME = (UTC_TIMESTAMP);
