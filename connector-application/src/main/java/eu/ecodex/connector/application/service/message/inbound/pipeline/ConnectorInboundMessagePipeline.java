 ...
 * {@link ConnectorLinkSubmitter} to submit processed messages for further actions or routing.
 */
@Slf4j
public class ConnectorInboundMessagePipeline implements ConnectorMessagePipeline {
     ...
     *                           messages.
     * @param linkSubmissionStep the service responsible for submitting the processed message to the
