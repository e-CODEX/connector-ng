...
/**
 * Defines the API for managing backend to connector (aka outbound message).
 */
@Tag(name = "OutboundMessageProcessing", description = "API for managing outbound message.")
@RequestMapping("/api/v1/messages/outbound")
public interface ConnectorOutboundMessageApi {
    ...
    ConnectorOutboundMessageDto submit(
