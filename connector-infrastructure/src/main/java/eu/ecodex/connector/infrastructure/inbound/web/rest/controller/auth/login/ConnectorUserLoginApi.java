 ...
 * Provides an operation for authenticating users and retrieving an access token upon successful login.
 * This interface serves as a contract for the implementation of user login services.
 * <p>
 * Endpoints:
 ...
 * - The @Tag annotation is used for grouping and describing the API in documentation generated via OpenAPI.
 */
