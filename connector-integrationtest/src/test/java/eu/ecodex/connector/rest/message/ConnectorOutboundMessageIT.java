...
@DisplayName("ConnectorOutboundMessageIT REST")
@Sql(
...
public class ConnectorOutboundMessageIT extends AbstractIntegrationTest {
    ...
    @Test
    @WithReferenceData
    void should_return_201_when_outbound_message_is_submitted() {
    ...
    @Test
    @WithReferenceData
    void should_return_201_when_outbound_message_is_submitted_without_attachment() {
    ...
    @Test
    @WithReferenceData
    void should_return_201_when_outbound_message_is_submitted_without_detached_signature() {
    ...
    private String uploadAttachment() {
        var parts = produceAttachmentPart(10);
