...
/**
 * Root configuration properties for the connector link module.
 *
 * <p>This class aggregates configuration for both the gateway and backend components involved in
 * the connector link setup.
 */
@Getter
@Setter
@Configuration
