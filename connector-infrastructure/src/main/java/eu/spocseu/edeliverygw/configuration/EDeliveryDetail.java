...
public class EDeliveryDetail {
    ...
    public static class Server {
        ...
        @XmlAttribute(name = "defaultCitizenQAAlevel")
        protected Integer defaultCitizenQAAlevel;
        @XmlAttribute(name = "gatewayName", required = true)
        @XmlSchemaType(name = "anySimpleType")
        protected String gatewayName;
        @XmlAttribute(name = "gatewayDomain")
        @XmlSchemaType(name = "anySimpleType")
        protected String gatewayDomain;
        @XmlAttribute(name = "gatewayAddress", required = true)
        @XmlSchemaType(name = "anySimpleType")
