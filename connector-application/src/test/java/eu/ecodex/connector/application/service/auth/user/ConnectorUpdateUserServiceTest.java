...
class ConnectorUpdateUserServiceTest {
    ...
    @Test
    void update_should_update_user() {
        // Given
        var identifier = "uuid";
        var username = "user";
        ...
        // When
        var registered = service.update(identifier, user);
    ...
    @Test
    void update_should_do_nothing_when_same_user() {
        // Given
        var identifier = "uuid";
        var username = "user";
        var email = "email@test.com";
    ...
    @Test
    void update_should_throw_user_not_found_exception() {
        // Given
        var identifier = "uuid";
        var username = "user";
        var email = "email@test.com";
        ...
        // When
        assertThrows(ConnectorUserNotFoundException.class, () -> service.update(identifier, user));
    ...
    @Test
    void update_should_throw_exception_when_mail_already_exists() {
        // Given
        var identifier = "uuid";
        var username = "user";
        var email = "email@test.com";
        ...
        assertThrows(ConnectorUserAlreadyExistsException.class,
            () -> service.update(identifier, user));
    ...
    @Test
    void update_should_throw_exception_when_mail_username_exists() {
        // Given
        // Given
        var identifier = "uuid";
        var username = "user";
