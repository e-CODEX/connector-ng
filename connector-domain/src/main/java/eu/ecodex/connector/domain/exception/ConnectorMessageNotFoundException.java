 ...
 * requested message is unavailable.
 */
public class ConnectorMessageNotFoundException extends NotFoundException {
    public ConnectorMessageNotFoundException(String message) {
        super(message);
    }
}
