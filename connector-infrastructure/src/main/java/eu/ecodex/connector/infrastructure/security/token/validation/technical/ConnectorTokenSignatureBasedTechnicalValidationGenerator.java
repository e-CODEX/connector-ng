...
import eu.ecodex.connector.infrastructure.security.model.DecisionData;
import eu.ecodex.connector.infrastructure.security.model.DiagnosisData;
import eu.ecodex.connector.infrastructure.security.model.ValidationData;
...
import eu.ecodex.connector.infrastructure.security.model.token.ConnectorTokenVerificationData;
import eu.ecodex.connector.infrastructure.security.model.token.signature.ConnectorTokenCertificateInformation;
import eu.ecodex.connector.infrastructure.security.model.token.signature.ConnectorTokenSignature;
import eu.ecodex.connector.infrastructure.security.model.token.signature.ConnectorTokenSignatureInformation;
import eu.ecodex.connector.infrastructure.security.model.token.signature.ConnectorTokenTechnicalValidationResult;
import eu.ecodex.connector.infrastructure.security.util.TechnicalValidationUtil;
