...
--  Against: null@offline:mysql?changeLogFile=target/liquibase/changelog-1.16.mysql
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog.xml::EDELIVERY-7836::gautifr
...
ALTER TABLE TB_D_MESSAGE_PROPERTY ADD COLUMN CONTENT_HASH VARCHAR(64) GENERATED ALWAYS AS (SHA2(CONCAT(IFNULL(NAME, ''), '|', IFNULL(VALUE, ''), '|', IFNULL(TYPE, '')), 256)) STORED;
...
ALTER TABLE TB_D_PART_PROPERTY ADD COLUMN CONTENT_HASH VARCHAR(64) GENERATED ALWAYS AS (SHA2(CONCAT(IFNULL(NAME, ''), '|', IFNULL(VALUE, ''), '|', IFNULL(TYPE, '')), 256)) STORED;
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog.xml::EDELIVERY-11509::idragusa
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog.xml::12066-1::Cosmin Baciu
CREATE INDEX IDX_DDC_FINAL_RECIPIENT ON TB_DDC_LOOKUP(FINAL_RECIPIENT);

--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog.xml::EDELIVERY-11796-add-pks-mysql::Gabriel Maier
